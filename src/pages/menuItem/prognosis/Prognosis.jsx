...
const Prognosis = observer(() => {
  ...
  let handleSubmit = async (e) => {
    e.preventDefault();
    let data = {
      text: `Ты профессиональный нумеролог Составь подробный и развернутый нумерологический прогноз на эту неделю для человека по имени ${name}, родившегося ${dateBirthday} года.  Учти числа этой недели (текущая дата ${dateBirthday}) и как они могут взаимодействовать с числом этого человека. Опиши подробные прогнозы на неделю относительно различных сфер жизни,  таких как карьера, отношения, здоровье и финансовые дела. Дай советы и рекомендации для  этого человека  на эту неделю. Составь полный и детализированный нумерологический прогноз на ближайшую неделю, учитывая все аспекты жизни этого человека. `,
    };
