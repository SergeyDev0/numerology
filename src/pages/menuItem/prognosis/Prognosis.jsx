...
const Prognosis = observer(() => {
  ...
  let handleSubmit = async (e) => {
    e.preventDefault();
    let data = {
      text: `Составь подробный и развернутый нумерологический прогноз на неделю для человека по имени ${name}, родившегося ${dateBirthday}. Прогноз должен включать анализ личных чисел дня, международных чисел жизненного пути на события и ситуации дня, а Также рекомендации для достижения гармонии и достижения результатов. Прогноз должен основываться на числах текущей даты - ${getCurrentDate()}, с акцентом на последующих шагах по самореализации и улучшению эмоционального состояния.`,
    };
