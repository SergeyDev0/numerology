...
const Prognosis = observer(() => {
  ...
  let handleSubmit = async (e) => {
    e.preventDefault();
    let data = {
      text: `Ты профессиональный нумеролог Составь подробный и развернутый нумерологический прогноз на неделю для человека по имени  ${name}, родившегося ${dateBirthday} года. Опиши подробные прогнозы относительно различных сфер жизни, таких как карьера, отношения, здоровье и финансовые дела. Дай советы и рекомендации для  этого человека  на эту неделю. Составь полный и детализированный нумерологический прогноз на ближайшую неделю (текущая дата ${getCurrentDate()} выводи её тоже), учитывая все аспекты жизни этого человека. `,
    };
