  ...
  const [dateBirthday, setDateBirthday] = React.useState("01.01.2020");
		...
		let handleSubmit = async (e, handlePrompt) => {
			...
			switch (isPrompt) {
				case "1":
					data = {
						text: `Опиши сначала что значат жизненные периоды в нумерологии Напиши советы для каждого из жизненных периодов для человека рожденного ${dateBirthday} по имени ${name}, в конце добавь фразу "чтобы узнать конкретно о жизненном периоде выберите какой вас интересует нажав на нужную кнопку"`,
					};
					break;
				case "2":
					data = {
